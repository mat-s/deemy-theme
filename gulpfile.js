...
const themeHeader = `/*
Theme Name: deemy-theme
Description: Hello Elementor Child Theme for Deemy, built with SCSS and Gulp
Author: Deemy
Author URI: https://example.com
Version: 1.0.0
Template: hello-elementor
Text Domain: deemy-theme
*/

`;

// Pfade definieren (deemy-theme)
const paths = {
  scss: {
    src: 'wp-content/themes/deemy-theme/assets/scss/**/*.scss',
    main: 'wp-content/themes/deemy-theme/assets/scss/main.scss',
    // style.css soll klassisch im Theme-Root liegen
    dest: 'wp-content/themes/deemy-theme/'
  },
  js: {
    src: 'wp-content/themes/deemy-theme/assets/js/**/*.js',
    dest: 'wp-content/themes/deemy-theme/assets/js/'
  },
  php: {
    src: 'wp-content/themes/deemy-theme/**/*.php'
  }
};
