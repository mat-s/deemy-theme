# Deemy WordPress Projekt

Modernes WordPress-Setup für lokale Entwicklung mit Docker und Gulp.  
Enthält ein eigenes Hello-Elementor-Child-Theme (`deemy-theme`) mit SCSS-Struktur.
...
- Child-Theme liegt unter:  
  `wp-content/themes/deemy-theme/`
- Haupt-SCSS-Datei:  
  `wp-content/themes/deemy-theme/assets/scss/main.scss`
- Kompiliertes CSS landet in:  
  `wp-content/themes/deemy-theme/style.css`
